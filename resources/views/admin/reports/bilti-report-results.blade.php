...
<div class="container-fluid">
                            ...
                            <tbody>
                                @forelse($receivables as $receivable)
                                    <tr>
                                        ...
                                        <td>{{ $receivable->payable->supplier->supplier_name ?? 'N/A' }}</td>
                                        <td>{{ $receivable->dealer->dealer_name ?? 'N/A' }}</td>
                                        <td>{{ \Carbon\Carbon::parse($receivable->payable->transaction_date)->format('d M, Y') }}</td>
                                        ...
                                        <td>{{ ucfirst($receivable->payment_type) }}</td>
                                        <td>
    ...
    <script>
        document.getElementById('exportPDF').addEventListener('click', function () {
            ...
            doc.save(`Bilti_Report_{{ \Carbon\Carbon::now()->format('d_M_Y') }}.pdf`);
        });
    </script>
</div>
@endsection