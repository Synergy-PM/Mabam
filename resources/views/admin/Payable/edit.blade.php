...
@section('content')
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{ route('payables.update', $payable->id) }}" method="POST" id="payableForm"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="amount_per_bag" id="amount_per_bag"
                                    class="form-control" value="{{ old('amount_per_bag', $payable->amount_per_bag) }}"
                                    required>
                        ...
                        <div id="dealersContainer">
                            @if (isset($receivables) && $receivables->count() > 0)
                                @foreach ($receivables as $index => $receivable)
                                    <div class="border p-3 mt-3 rounded bg-light dealer-form"
                                        data-index="{{ $index }}">
                                        <input type="hidden" name="receivable_id[{{ $index }}]"
                                            value="{{ $receivable->id }}">
                                        <div class="row">
                                            <div class="col-md-4 mb-3 position-relative">
                                                ...
                                                <input type="hidden" name="dealer_id[{{ $index }}]"
                                                    class="dealer_id" value="{{ $receivable->dealer_id }}" required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>Bags <span class="text-danger">*</span></label>
                                                <input type="number" name="bags[{{ $index }}]"
                                                    class="form-control bagsInput"
                                                    value="{{ old('bags.' . $index, $receivable->bags) }}" min="1"
                                                    required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>Tons</label>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" step="0.01" name="rate[{{ $index }}]"
                                                    class="form-control rate"
                                                    value="{{ old('rate.' . $index, $receivable->rate) }}" min="0.01"
                                                    required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>Freight</label>
                                                <input type="number" step="0.01" name="freight[{{ $index }}]"
                                                    ...
                                                    value="{{ old('freight.' . $index, $receivable->freight ?? 0) }}"
                                                    min="0">
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>Total</label>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select name="payment_type[{{ $index }}]" class="form-control"
                                                    ...
                                                    <option value="credit"
                                                        ...
                                                        Credit</option>
                                                    <option value="cash"
                                                        {{ old('payment_type.' . $index, $receivable->payment_type) == 'cash' ? 'selected' : '' }}>
                                                        Cash</option>
                                                    <option value="online"
                                                        {{ old('payment_type.' . $index, $receivable->payment_type) == 'online' ? 'selected' : '' }}>
                                                        Online</option>
                                                    <option value="cheque"
                                                        {{ old('payment_type.' . $index, $receivable->payment_type) == 'cheque' ? 'selected' : '' }}>
                                                        Cheque</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>Proof of Payment</label>
                                                <input type="file" name="proof_of_payment[{{ $index }}]"
                                                    class="form-control" accept="image/*,.pdf">
                                                @if ($receivable->proof_of_payment)
                                                    <small class="text-muted mt-1 d-block">
                                                        Current: <a
                                                            href="{{ asset('storage/' . $receivable->proof_of_payment) }}"
    ...
    <script>
        ...
        dealersContainer.addEventListener('input', function(e) {
            ...
            if (e.target.classList.contains('rate') || e.target.classList.contains('dealerFreight') || e.target
                .classList.contains('bagsInput')) {
                calculateTotals();
            }
        });
